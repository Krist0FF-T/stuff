...
static const int flippableC = 7,
    flippable[flippableC] = {bt_dirt,bt_grass,bt_log,bt_sand,bt_leaf,bt_stone};
...
void drawCubeTextureFaces(Vector3 position, Faces faces, int type) {
    ...
    3: left, right
    */ //                0         1         2                 3
    int c[4] = {(int)(255*0.8f), 255, (int)(255*0.4f), (int)(255*0.6f)}; //{230, 255, 204};
